...
@Component({
  selector: 'ProductSaleComponent',
  template: `
  <section class="home" id="home">
  <div class="homeContent">
      <h2>Delicious Cake for Everyone </h2>
      <p style="color:#999999">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum excepturi doloribus, fuga quod deserunt
          recusandae?</p>
      <div class="home-btn">
...
<section class="product" id="product">
  <div class="heading">
    ...
    <ng-container *ngFor="let item of filterProductList.slice(4,7)">
      <div class="swiper-wrapper"  >
  ...
  <div class="swiper-pagination"></div>
  <div class="swiper product-row">
  <ng-container *ngFor="let item of filterProductList.slice(7,10)">
    <div class="swiper-wrapper">
      <div class="swiper-slide box" style="background-color: rgb(213, 213, 209)">
        <div class="img">
          <img [src]="item.imageUrl" alt="{{ item.productName }}">
        ...
        <div class="product-content">
          <h3><a [routerLink]="['/product-details', item.id]">{{ item.productName }}</a></h3>
          <p class="card-text" style=" text-decoration: line-through; color:red">{{item.sale}}$</p>
          <p>{{ item.price | currency:'USD':true }}</p>
          <div class="orderNow">
            <button [routerLink]="['/product-details', item.id]">Order Now</button>
          </div>
  ...
  *{
  ...
  html::-webkit-scrollbar-thumb{
    ...
    .home {
      ...
      display: flex;
      align-items: center;
      background: url(/assets/images/back3.jpg) no-repeat;
