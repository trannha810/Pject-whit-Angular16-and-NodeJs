...
<div class="row maunen1">
    <ul class="nav nav-tabs "  style="padding:10px 10px 0px 10px;font-size: 30px; color:black;">
        ...
        <li class="nav-item ">
            <a href="#noibat" [routerLink]="['']"  class="nav-link active" data-toggle="tab">Sản Phẩm Bánh Chạy</a>
        </li>
        ...
        <input
type="text"
size="57px" style="padding:20px 20px 20px 38px;"
[(ngModel)]="searching"
...
<section class="product" id="product">
  ...
  <div class="swiper-pagination"></div>
  <div class="swiper product-row">
  <ng-container *ngFor="let item of filterProductList.slice(13,16)">
    <div class="swiper-wrapper">
      <div class="swiper-slide box" style="background-color: rgb(213, 213, 209)">
        <div class="img">
          <img [src]="item.imageUrl" alt="{{ item.productName }}">
  ...
  <pagination-controls (pageChange)="p = $event"  style="font-size: 20px;margin-left: z ;"></pagination-controls>
</section>
